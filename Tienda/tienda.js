...
var servidor=http.createServer(function(pedido,respuesta){
   ...
   var objetourl = url.parse(pedido.url,true);
...
function encaminar (pedido,respuesta,camino) {
   ...
   switch (camino) {
       ...
       default : { 
           ...
           fs.open(camino, 'wx', function(existe){
...
function alta(pedido,respuesta) {
   ...
   pedido.on('end', function(){
     ...
     console.log(formulario.get('descripcion'));

     console.log(formulario.get('precio'));
...
function consulta(pedido,respuesta) {
   ...
   pedido.on('end', function(){
       ...
       var dato=formulario.get('codigo');
